package io.github.mcpaimon.extension.player.papermc;
...
/**
 * The PlayerTools extension class for the MCAgents system on PaperMC.
...
public class PlayerTools implements IMCExtension {
    ...
    public void onLoad(Object plugin, Executor executor) {
        if (plugin instanceof MCAgentsPlugin mcagentsPlugin) {
            ...
            mcagentsPlugin.getLogger().info("PlayerTools extension loaded successfully on PaperMC. Tools registered.");
    ...
    public void onDisable(Object plugin, Executor executor) {
        if (plugin instanceof JavaPlugin javaPlugin) {
            javaPlugin.getLogger().info("PlayerTools extension has been disabled on PaperMC.");
        }
    }
}
